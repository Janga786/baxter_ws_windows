...
if("TRUE" STREQUAL "TRUE")
  set(baxter_moveit_config_SOURCE_PREFIX /root/baxter_ws/src/baxter_moveit_config)
  set(baxter_moveit_config_DEVEL_PREFIX /root/baxter_ws/devel)
  ...
  set(baxter_moveit_config_INSTALL_PREFIX /root/baxter_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/baxter_ws/src/baxter_moveit_config/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>' to fix it.")
    endif()
